  ...
  const stats = [
    {
      value: "100%",
      description:
        "professional printed materials designed to represent your business and brand.",
    },
    {
      value: "24/7",
      description:
        "your business can stay visible with branded materials customers can see offline.",
    },
    {
      value: "1",
      description:
        "consistent brand identity across your business cards, flyers, postcards, and more.",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "High-quality printed materials designed to represent your business professionally.",
    },
    {
      icon: Megaphone,
      title: "Promote Your Business",
      description:
        "Put your company name and services in front of more potential customers with professional marketing materials.",
    },
    {
      icon: FileText,
      title: "Business Materials",
      description:
        "Create professional materials for everyday business needs and customer interactions.",
    },
    {
      icon: BriefcaseBusiness,
      title: "Consistent Branding",
      description:
        "Keep your visual identity consistent across your business cards, flyers, postcards, and other printed materials.",
    },
    {
      icon: Star,
      title: "Look Professional",
      description:
        "Make a stronger impression with polished business materials that help customers remember your company.",
    },
    {
      icon: Package,
      title: "Built For Contractors",
      description:
        "Printing options designed around the needs of real home service and contractor businesses.",
    },
  ];
  ...
  return (
    <>
      ...
      <main className="overflow-hidden bg-[#F3F4F6]">
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-[390px_1fr]">
              ...
              <div className="rounded-xl bg-white px-5 py-6 sm:px-7 sm:py-8 lg:px-8 lg:py-9">
                ...
                <div className="mt-7 overflow-hidden rounded-lg">
                  <img
                    src="/images/products/printing-services.jpg"
        ...
        {/* ==================================================
            WHY DO I NEED PRINTING SERVICES?
        ================================================== */}
              ...
              <div className="grid min-h-[300px] items-center lg:grid-cols-[1fr_430px]">
                ...
                <div className="px-7 py-12 sm:px-10 sm:py-14 lg:px-14">
                  ...
                  <h2 className="max-w-2xl text-3xl font-black leading-tight tracking-[-0.04em] text-white sm:text-4xl lg:text-5xl">
                    Ready to put your business everywhere?
                  </h2>

                  <p className="mt-5 max-w-xl text-sm leading-7 text-slate-400 sm:text-base">
                    Create professional printed materials that keep your
                    business visible, build trust, and help customers
                    remember your brand.
                  </p>
                ...
                <div className="hidden h-full min-h-[300px] items-end justify-center lg:flex">
                  <img
                    src="/images/products/printing-services-cta.png"
                    alt="Printing Services"
